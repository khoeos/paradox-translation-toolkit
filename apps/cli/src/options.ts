import { DEFAULT_MOD_NAME, posixJoin } from '@ptt/converter-core'
import { getAllGameIds, getGame } from '@ptt/game-registry'
import type { GameDefinition } from '@ptt/shared-types'
import { CONVERT_MODES, LANGUAGE_CODES, LanguageCodeSchema } from '@ptt/shared-types'
import type { ConvertMode, LanguageCode } from '@ptt/shared-types'
import type { TranslateConfig } from '@ptt/translate-core'
import { PROVIDER_DEFAULTS, TRANSLATE_DEFAULTS, TRANSLATE_PROVIDERS } from '@ptt/translate-core'
