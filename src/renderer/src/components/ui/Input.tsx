    ...
    return (
      ...
      >
        <input
          type={type}
          className={cn(
            'grow bg-background px-3 py-2 text-sm ring-offset-background placeholder:text-muted-foreground focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50'
          )}
          {...props}
        />
        <FolderIcon
          className="shrink-0 w-6 h-6 mr-2 text-gray-300 cursor-pointer"
